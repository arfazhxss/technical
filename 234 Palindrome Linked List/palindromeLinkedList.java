public class palindromeLinkedList {
    ...
    public static ListNode reverseLinkedList(ListNode root) {
        ...
        /*
         * This makes the main head linkedList cut out, since in the main array [1,2,3,4,5,4,3,2,1], slow is stuck at 5, which is passed as a parameter as 'root', the next of root is slayed to 'null' cutting the main 'head' linkedlist into one [1,2,3,4,5].
         */
